...
typedef bool (*DataConfig_Callback)( void *config, const char *name, const char *value );
/*
 * base constructor
 *
...
bool
parseData (void *data,IDirectFBDataBuffer *databuffer, DataConfig_Callback callback );
