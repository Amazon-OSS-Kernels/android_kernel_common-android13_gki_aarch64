...
#define HCI_VENDOR_APCF_SUB             0xFD57
#define HCI_VSC_IR_SET                  0xFCB2    /* For Amazon */
#define HCI_BLE_SET_EXT_SCAN_PARAM      0x2041
#define HCI_BLE_SET_EXT_SCAN_ENABLE     0x2042
#define HCI_LE_ADD_ACPT_LIST            0x2011
...
#define REVERSE_UINT32(u32)      ((u32/0x01000000) | (((u32/0x00010000)%0x0100) << 8) | (((u32/0x00000100)&(0x0000FF)) << 16) | ((u32%0x00000100) << 24))
