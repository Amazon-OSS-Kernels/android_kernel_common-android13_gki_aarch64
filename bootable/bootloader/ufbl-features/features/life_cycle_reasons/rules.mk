...
ifeq ($(UFBL_PROJECT),$(filter $(UFBL_PROJECT),ABC ABC_proto ABC ABC ABC ABC ABC ABC ABC ABC ABC ABC ABC))
OBJS += \
    $(LOCAL_DIR)/life_cycle_reasons_mtk.o
endif

ifeq ($(UFBL_PROJECT),$(filter $(UFBL_PROJECT),ABC ABC ABC ABCp ABC ABCt))
OBJS += \
