...
UFBL_LIBS += $(FEATURE_DIR)/replay_protected_unlock/libreplay_protected_unlock.o
endif
...
UFBL_LIBS += $(FEATURE_DIR)/yubikey_unlock_public_key_tag/libyubikey_unlock_public_key_tag.o
endif
