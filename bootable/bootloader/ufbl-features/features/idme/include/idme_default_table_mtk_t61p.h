/*
 * idme_default_table_mtk_t61p.h
 *
 * Copyright 2022 - 2023 Amazon.com, Inc. or its affiliates. All Rights Reserved.
 */

/*!
 * @file idme_default_table_mtk_t61p.h
 * @brief This file contains idme default table values
 *  in the userstore partition
 *
 */

#ifndef __IDME_DEFAULT_TABLE_MTK_T61P_H__
#define __IDME_DEFAULT_TABLE_MTK_T61P_H__
...
const struct idme_init_values idme_default_values[] = {
	...
	{ { "config_name", 256, 1, 0444 },
		/* for dataindex_cfg_name */
		"0"
	},
	{ { "key_layout", 8, 1, 0444 },
...
#if defined(UFBL_FEATURE_TEMP_UNLOCK) || defined(UFBL_FEATURE_REPLAY_PROTECTED_UNLOCK)
	{ { "t_unlock_code", 512, 1, 0444 },
		/* Temporary/Replay_protected unlock signed code, base64 encoded */
		""
	},
	{ { "t_unlock_cert", 1024, 1, 0444 },
		/* Temporary/Replay_protected unlock signed certificate, base64 encoded */
		""
	},
#endif
	{ { "", 0, 0, 0 }, 0 },
...
#endif /* __IDME_DEFAULT_TABLE_MTK_T61P_H__ */
