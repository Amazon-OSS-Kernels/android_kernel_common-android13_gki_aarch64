...
const struct idme_init_values idme_default_values[] = {
	...
	{ { "zbthrd_mac_addr", 16, 1, 0444 },
		/* Zigbee / Thread MAC Address */
		"0"
	},
	{ { "", 0, 0, 0 }, 0 },
};
...
#endif /* __IDME_DEFAULT_TABLE_AML_T96XD4_H__ */
