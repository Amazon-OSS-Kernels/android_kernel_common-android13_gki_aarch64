...
typedef enum _eMIUIoctlCmd
{
    ...
    MDrv_CMD_MIU_SetClientUtilization,
    MDrv_CMD_MIU_GetClientUtilization,
    MDrv_CMD_MIU_SetClientEfficiency,
    MDrv_CMD_MIU_GetClientEfficiency,
    MDrv_CMD_MIU_SetBWValue,
    MDrv_CMD_MIU_GetBWValue,
    MDrv_CMD_MIU_GetMIUInfo,
    MDrv_CMD_MIU_GetBWAll,
    MDrv_CMD_MIU_StartBWMonitor,
    MDrv_CMD_MIU_SetCPUHPriority,
}eMIUIoctlCmd;
...
typedef struct DLL_PACKED _MIU_PROTECTEx
{
    MS_U8 u8Blockx;
...
typedef struct DLL_PACKED _MIU_BWUTILIZATION
{
    MS_U8 u8MiuDev;
    eMIUClientID eClientID;
    MS_U32 *pu32BWUtilization;
}MIU_BWUTILIZATION, *PMIU_BWUTILIZATION;

typedef struct DLL_PACKED _MIU_BWEFFICIENCY
{
    MS_U8 u8MiuDev;
    eMIUClientID eClientID;
    MS_U32 *pu32BWEfficiency;
}MIU_BWEFFICIENCY, *PMIU_BWEFFICIENCY;

typedef struct DLL_PACKED _MIU_SETGETBW
{
    MS_U32 u32ClientID;
    MIU_BW_TYPE eBWINfoType;
    MIU_UMA_Mode *peUMAMode;
    MIU_BWValue *pBWValue;
}MIU_SETGETBW, *PMIU_SETGETBW;

typedef struct DLL_PACKED _MIU_GETINFO
{
    MIU_ID eMiu;
    MIU_Info *pstMIUInfo;
}MIU_GETINFO, *PMIU_GETINFO;

typedef struct DLL_PACKED _MIU_SETCPUHPRI
{
    MIU_HPri_Scope eScope;
    MS_U64 u64Start;
    MS_U64 u64End;
    MS_BOOL bEnable;
}MIU_SETCPUHPRI, *PMIU_SETCPUHPRI;
