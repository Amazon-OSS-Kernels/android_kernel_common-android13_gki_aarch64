...
typedef enum
{
    ...
    E_SYS_QUERY_PTK_NOT_SUPPORTED = 0x30,
    E_SYS_QUERY_AIPQ_IC_SUPPORTED = 0x31,
    E_SYS_QUERY_IWEDIA_HTML5_SUPPORTED = 0x32,
    E_SYS_QUERY_IWEDIA_HBBTV_SUPPORTED = 0x33,
    E_SYS_QUERY_IWEDIA_OPEN_BROWSER_SUPPORTED = 0x34,
    E_SYS_QUERY_MDLA_SUPPORTED = 0x35,
    E_SYS_QUERY_GPU_AIPQ_SUPPORTED = 0x36,
    E_SYS_QUERY_MEMC_60_SUPPORTED = 0x37,
    E_SYS_QUERY_MEMC_120_SUPPORTED = 0x38,
    E_SYS_QUERY_MPLL_LVDS_CLK_OLD_MODE_SUPPORTED = 0x39,
    E_SYS_QUERY_ADCPLL_CLK_SHORT_PATH_SUPPORTED = 0x40,
    E_SYS_QUERY_ADCPLL_CLK_LONG_PATH_SUPPORTED = 0x41,
    E_SYS_QUERY_ADCPLL_CLK_GAS_PATH_SUPPORTED = 0x42,
    E_SYS_QUERY_CLK_MCU_PM_DEGLITCH_MUX_SELECT_SUPPORTED = 0x43,
    E_SYS_QUERY_LZMA_SELECT_SUPPORTED = 0x44,
    E_SYS_QUERY_HVD_MODE_SUPPORTED = 0x45,
    E_SYS_QUERY_MVOP_MODE_SUPPORTED = 0x46,
    E_SYS_QUERY_MIU_STR_SELECT_SUPPORTED = 0x47,
    E_SYS_QUERY_MIU_SINGLE_COMMAND_ACCESS_SUPPORTED = 0x48,
    E_SYS_QUERY_ROM_BOOT_DC_AC_CHECK_SUPPORTED = 0x49,
    E_SYS_QUERY_MIU_RETRY_SUPPORTED = 0x4A,
    E_SYS_QUERY_GOP_DYNAMIC_TYPE_PATCH_SELECT_SUPPORTED = 0x4B,
    E_SYS_QUERY_DVFS_MODE_CHECK_SUPPORTED = 0x4C,
    E_SYS_QUERY_VDD_SELECT_SUPPORTED = 0x4D,
    E_SYS_QUERY_VDD_CPU_SELECT_SUPPORTED = 0x4E,
    E_SYS_QUERY_NRDI_MODE_SUPPORTED = 0x4F,
    E_SYS_QUERY_AUDIO_SW_RESET_PATCH_SUPPORTED = 0x50,
    E_SYS_QUERY_HDMI_MODE_SUPPORTED = 0x51,
    E_SYS_QUERY_FOXXUM_TV_STORE_SUPPORTED = 0x52,
    E_SYS_QUERY_ANDROID_SUPPORTED = 0x53,
    E_SYS_QUERY_AV_1_SUPPORTED = 0x54,
    E_SYS_QUERY_HVD_UHD_SUPPORTED = 0x55,
    E_SYS_QUERY_EVD_UHD_SUPPORTED = 0x56,
    E_SYS_QUERY_VB1_SUPPORTED = 0x57,
    E_SYS_QUERY_HDMI_2X_SUPPORTED = 0x58,
    E_SYS_QUERY_HDMI_DLEV_TARGET_128MV_SUPPORTED = 0x59,
    E_SYS_QUERY_PLAY_RDY_SUPPORTED = 0x5A,
    E_SYS_QUERY_AVS2_SUPPORTED = 0x5B,
    E_SYS_QUERY_AIAQ_SCENE_DETECTION_SUPPORTED = 0x5C,
    E_SYS_QUERY_LVDS_SUPPORTED = 0x5D,
    E_SYS_QUERY_MIPI_SUPPORTED = 0x5E,
...
typedef enum
{
  ...
  E_QOS_EVENT_TIMEOUT,
  // Bandwidth adjust
  E_QOS_EVENT_BW_ADJUST,
  // Codec change event, reference ST_QOS_INPUT_SOURCE_INFO structure.
  E_QOS_EVENT_CODEC_CHANGE,
  // Input source change event, reference ST_QOS_INPUT_SOURCE_INFO structure.
  E_QOS_EVENT_INPUT_SOURCE_CHANGE,
  // Input source ready event, input source is stable and waiting to display, reference ST_QOS_INPUT_SOURCE_INFO structure.
  E_QOS_EVENT_INPUT_SOURCE_READY,
  // PVR event
  E_QOS_EVENT_PVR,
  // Capture event
  E_QOS_EVENT_CAPTURE,
...
typedef enum
{
  // Scaler module bandwidth
  E_QOS_BW_SCALER = 0x00000001,
  // FRC module bandwidth
  E_QOS_BW_FRC = 0x00000002,
  // Panel module bandwidth
  E_QOS_BW_PNL = 0x00000004,
  // PQ module bandwidth
  E_QOS_BW_PQ = 0x00000008,
  // VDEC module bandwidth
  E_QOS_BW_VDEC = 0x00000010,
  // AI PQ module bandwidth
  E_QOS_BW_AI_PQ = 0x00000020,
  // All module
  E_QOS_BW_ALL = 0xFFFFFFFF,
//  E_QOS_BW_MAX = E_QOS_BW_ALL
} EN_QOS_BW_MODULE;

typedef enum
{
  // specify bandwidth level.
  E_QOS_BW_LEVEL,
  // specify bandwidth usage.
  E_QOS_BW_USAGE,
  E_QOS_BW_MAX
} EN_QOS_BW_TYPE;
...
typedef enum
{
  // When upper module use fix bandwidth level offset, QoS keep bandwidth level offset after QoS auto adjust bandwidth level.
  E_QOS_ADJUST_FIX,
  // When upper module use auto reset bandwidth level offset, QoS auto reset bandwidth level after QoS auto adjust bandwidth level.
  E_QOS_ADJUST_AUTO_RESET,
  E_QOS_ADJUST_MAX
} EN_QOS_ADJUST_TYPE;
...
typedef enum
{
  ...
  E_QOS_RESULT_FAIL,
  // Not support
  E_QOS_RESULT_NOT_SUPPORT,
  // Invalid parameter
  E_QOS_RESULT_INVALID_PARAMETER,
  // BW level out of range
  E_QOS_RESULT_BW_OUT_OF_RANGE,
  E_QOS_RESULT_MAX
} EN_QOS_RESULT;
...
typedef struct DLL_PACKED
{
  MS_U32 u32Version;
  MS_U32 u32Length;
  // QoS common bin file path.
  char sCommonBinFileName[FILE_PATH_SIZE];
  // QoS customer bin file path
  char sCustomerBinFileName[FILE_PATH_SIZE];
  // Bandwidth level threshold
  MS_U32 u32BwLevelThreshold[LEVEL_MAX];
  // QoS system enable flag
  MS_BOOL bSysEnable;
  // QoS auto adjust bandwidth enable flag
  MS_BOOL bAutoAdjBwEnable;
  // Decrease bandwidth level delay count.
  MS_U32 u32DecreaseBwDelayCount;
  // Increase bandwidth level delay count.
  MS_U32 u32IncreaseBwDelayCount;
  // Check bandwidth period (ms)
  MS_U32 u32CheckBwPeriod;
} ST_QOS_INIT_INFO;
...
typedef struct DLL_PACKED
{
  MS_U32 u32Version;
  MS_U32 u32Length;
  // specify vdec bandwidth level.
  MS_U8 u8VdecLevel;
  // specify scaler bandwidth level.
  MS_U8 u8ScalerLevel;
  // specify FRC bandwidth level.
  MS_U8 u8FrcLevel;
  // specify panel bandwidth level.
  MS_U8 u8PnlLevel;
  // specify pq bandwidth level.
  MS_U8 u8PqLevel;
  // specify AI PQ bandwidth level.
  MS_U8 u8AipqLevel;

} ST_QOS_SITUATION_INFO;
...
typedef struct DLL_PACKED
{
  ...
  MS_U32 u32WinId;
  // Input source type
  MS_U32 u32InputSource;
  // Input source format. DTV/MM input source, u32Format means codec type.
  MS_U32 u32Format;
  // Video width
  MS_U32 u32Width;
  // Video height
  ...
  // frame per second
  MS_U32 u32Fps;
} ST_QOS_INPUT_SOURCE_INFO;

typedef struct DLL_PACKED
{
  MS_U32 u32Version;
  MS_U32 u32Length;
  // adjust bandwidth module, ex: scaler.
  EN_QOS_BW_MODULE enModule;
  // specify adjust bandwidth level or usage.
  EN_QOS_BW_TYPE enBwType;
  // specify bandwidth value depend on enBwType.
  MS_S32 s32BwValue;
  // adjust type
  EN_QOS_ADJUST_TYPE enAdjType;
} ST_QOS_BW_ADJUST_INFO;
...
typedef struct DLL_PACKED
{
  ...
  MS_U32 u32Length;
  // Event type.
  EN_QOS_EVENT_TYPE enEventType;
  // bandwidth adjust information.
  ST_QOS_BW_ADJUST_INFO stAdjustInfo;
  // Input source information, it includes input source type, resolution and etc….
  ST_QOS_INPUT_SOURCE_INFO stInputSourceInfo;
  // PVR enable
  MS_BOOL bPvrEn;
  // Capture enable
  MS_BOOL bCapEn;
...
typedef enum _QOS_DbgLv
{
    E_QOS_DBGLV_0,          //no debug message
    E_QOS_DBGLV_1,          //print utopia (MDrv_QoS_NotifyModuleStatusCb) and SDK/MI/ADP (MApi_QOS_SetModuleStatus) log
    E_QOS_DBGLV_2,          //print upper module (MApi_QoS_AdjustBwByLevel) log
    E_QOS_DBGLV_3,          //print event monitor thread log
    E_QOS_DBGLV_4,          //print result of check real and QoS table bandwidth setting
}QOS_DbgLv;
...
//-------------------------------------------------------------------------------------------------
MS_U8           MDrv_SYS_GetChipVer(void);
/// MOBF Encrypt
/// @ingroup G_SYS_COMMON
/// @param u32Key \b IN: Key
/// @param bEnable \b IN: TRUE/FLASE
...
EN_QOS_RESULT SYMBOL_WEAK MDrv_QOS_Initialize(ST_QOS_INIT_INFO stInitInfo);
EN_QOS_RESULT SYMBOL_WEAK MDrv_QOS_SetModuleStatus(ST_QOS_EVENT_INFO stEvent);
EN_QOS_RESULT SYMBOL_WEAK MDrv_QOS_GetStatus(ST_QOS_STATUS *pstStatus);
EN_QOS_RESULT SYMBOL_WEAK MDrv_QOS_SetStatus(ST_QOS_STATUS stStatus);
EN_QOS_RESULT SYMBOL_WEAK MDrv_QOS_AdjustBw (ST_QOS_BW_ADJUST_INFO stAdjustInfo);
EN_QOS_RESULT SYMBOL_WEAK MDrv_QOS_SetDebugType(MS_U8 u8Type);
EN_QOS_RESULT SYMBOL_WEAK MDrv_QOS_GetBwInfo(ST_QOS_BW_INFO *pstBwInfo);
EN_QOS_RESULT SYMBOL_WEAK MDrv_QOS_Suspend(void);
EN_QOS_RESULT SYMBOL_WEAK MDrv_QOS_Resume(void);
...
//-------------------------------------------------------------------------------------------------
/// SYS Virtual Efuse Setting
/// @param bMode \b IN: Set efuse virtual mode to TRUE/FALSE
/// @return MS_BOOL :
/// - TRUE: Success
/// - FALSE: Fail
//-------------------------------------------------------------------------------------------------
MS_BOOL MDrv_SYS_SetEfuseVirtualMode(MS_BOOL bMode);

//-------------------------------------------------------------------------------------------------
/// SYS Virtual Efuse Value Setting
/// @param u8SubBank \b IN: efuse subbank address
/// @param u32Value \b IN: efuse value to set
/// @return MS_BOOL :
/// - TRUE: Success
/// - FALSE: Fail
//-------------------------------------------------------------------------------------------------
MS_BOOL MDrv_SYS_SetEfuseVirtualValue(MS_U8 u8SubBank, MS_U32 u32Value);
