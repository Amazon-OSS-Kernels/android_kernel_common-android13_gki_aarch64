...
typedef enum
{
    ...
    E_XC_CMD_GET_FRCSWVERSION,
    E_XC_CMD_GET_FRCFSCCTRLPOLICY,
...
//** OBSELETE FUNCTION**//
    ...
    E_XC_CMD_MEM_ENABLE,
    E_XC_CMD_GET_IP_STATUS,
    E_XC_CMD_GET_VIDEO_LATENCY,
    E_XC_CMD_TEST_FUNCTION,
    E_XC_CMD_HSE_CONTROL,
    E_XC_CMD_SET_SCALER_BW_LEVEL,
    E_XC_CMD_SET_QOS_CALLBACKFUN,
    E_XC_CMD_SET_FRC_BW_LEVEL,
    E_XC_CMD_SET_LOWLATENCYMODE,
    E_XC_CMD_SET_DS_FORCE_INDEX_EXT,
    E_XC_CMD_SET_VRRON,
    E_XC_CMD_CUSSTR_ENABLE,
    E_XC_CMD_GET_CUSSTRSTATUS,
    E_XC_CMD_SET_EVENT,
    E_XC_CMD_SET_RW_POINT_DIFF,
    E_XC_CMD_SRC_SIG_CONTROL,
...
//** OBSELETE FUNCTION**//
    ...
    E_XC_PCMONITOR_CMD_GET_VFREQX10NODELAY,
    E_XC_PCMONITOR_CMD_GET_VFREQX1KNODELAY,
    ...
    E_XC_PCMONITOR_CMD_GETTIMINGINFO,
...
typedef struct
{
    MS_BOOL bEnable;
    E_APIXC_ReturnValue eReturnValue;
} stXC_HSE_CONTROL, *pstXC_HSE_CONTROL;

typedef struct
{
    ST_XC_EVENT *pstXCEvent;
    E_APIXC_ReturnValue eReturnValue;
} stXC_SET_EVENT, *pstXC_SET_EVENT;
...
typedef struct DLL_PACKED
{
    ST_XC_FRCSWVERSION* pstXCFrcSwVersion;
    E_APIXC_ReturnValue enReturnValue;
}stXC_FRCSWVERSION, *pstXC_FRCSWVERSION;

typedef struct DLL_PACKED
{
    ST_XC_FRCFSCCTRLPOLICY* pstXCFrcFscCtrlPolicy;
    E_APIXC_ReturnValue enReturnValue;
}stXC_FRCFSCCTRLPOLICY, *pstXC_FRCFSCCTRLPOLICY;
...
typedef struct DLL_PACKED
{
    ST_XC_MEM_ENABLE_CTRL* pstMemEnableCtrl;
    E_APIXC_ReturnValue eReturnValue;
} stXC_MEM_ENABLE, *pstXC_MEM_ENABLE;

typedef struct
{
    ST_XC_IP_STATUS* pstGetIPStatus;
    E_APIXC_ReturnValue enReturnValue;
} ST_XC_GETIPSTATUS,*pstXC_GETIPSTATUS;

typedef struct DLL_PACKED
{
    ST_XC_VIDEO_LATENCY_INFO *pstVideoLatencyInfo;
    SCALER_WIN enWindow;
    E_APIXC_ReturnValue enReturnValue;
} stXC_VIDEO_LATENCY_INFO, *pstXC_VIDEO_LATENCY_INFO;

typedef struct DLL_PACKED
{
    ST_XC_QOS_SCALER_BW_INFO *pstQosBWInfo;
    E_APIXC_ReturnValue enReturnValue;
}stXC_QOS_SCALER_BW_INFO, *pstXC_QOS_SCALER_BW_INFO;

typedef struct DLL_PACKED
{
    ST_XC_QOS_FRC_BW_INFO *pstQosBWInfo;
    E_APIXC_ReturnValue enReturnValue;
}stXC_QOS_FRC_BW_INFO, *pstXC_QOS_FRC_BW_INFO;

typedef struct DLL_PACKED
{
    ST_XC_QOS_CALLBACK_INFO* pstCallBack;
    E_APIXC_ReturnValue enReturnValue;
}stXC_QOS_CALLBACK_INFO, *pstXC_QOS_CALLBACK_INFO;

typedef struct DLL_PACKED
{
    ST_XC_SET_LOWLATENCYMODE_INFO *pstSetLowLatencyModeInfo;
    MS_U8 u8WinId;
    MS_BOOL bReturnValue;
}stXC_SET_LOWLATENCYMODE, *pstXC_SET_LOWLATENCYMODE;

typedef struct
{
    SCALER_WIN enWindow;
    ST_XC_DS_FORCEINDEX_EXT *pstDSForceIndexExt;
    E_APIXC_ReturnValue enReturnValue;
} stXC_SET_DS_FORCE_INDEX_EXT, *pstXC_SET_DS_FORCE_INDEX_EXT;

typedef struct
{
    MS_BOOL bEnable;
    E_APIXC_ReturnValue enReturnValue;
} stXC_SET_VRRON, *pstXC_SET_VRRON;

typedef struct DLL_PACKED
{
    MS_BOOL bEnable;
    E_APIXC_ReturnValue enReturnValue;
}stXC_CUSSTR_ENABLE, *pstXC_CUSSTR_ENABLE;

typedef struct DLL_PACKED
{
    MS_BOOL bEnable;
}stXC_GET_CUSSTRSTATUS, *pstXC_GET_CUSSTRSTATUS;

typedef struct DLL_PACKED
{
    ST_XC_SET_RW_POINT_DIFF stRWPointDiff;
    E_APIXC_ReturnValue enReturnValue;
}stXC_SET_RWPOINTDIFF, *pstXC_SET_RWPOINTDIFF;

typedef struct
{
    ST_XC_SRC_SIG_CTL *pstSrcSigCTL;
    E_APIXC_ReturnValue enReturnValue;
}stXC_SRCSIG_CTL, *pstXC_SRCSIG_CTL;
