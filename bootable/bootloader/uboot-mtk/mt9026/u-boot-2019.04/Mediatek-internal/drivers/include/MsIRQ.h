...
typedef enum
{
    ...
    E_INT_IRQ_SC_HK_INT                 = E_INT_IRQ_0x1D0_START +11,   //M7632
    E_INT_IRQ_EARC_TX_INT               = E_INT_IRQ_0x1D0_START +12,   //M7632
    E_INT_IRQ_FSP_DEMURA_INT            = E_INT_IRQ_0x1D0_START +13,   //M7632
    E_INT_IRQ_LZMA_INT                  = E_INT_IRQ_0x1D0_START +14,   //M7632
    E_INT_IRQ_PAGA_INT_LEVEL            = E_INT_IRQ_0x1D0_START +15,   //M7632
    E_INT_IRQ_0x1D0_END                 = 0x1df,

    E_INT_IRQ_0x1E0_START               = 0x1e0,
    E_INT_IRQ_ADCPLL_INT                = E_INT_IRQ_0x1E0_START + 0,   //M7632
    E_INT_IRQ_DS_SUB_INT                = E_INT_IRQ_0x1E0_START + 1,   //M7632
    E_INT_IRQ_AIA_MDLA_NS_INT           = E_INT_IRQ_0x1E0_START + 2,   //M7642
    E_INT_IRQ_AIA_CONN_INT              = E_INT_IRQ_0x1E0_START + 3,   //M7642
    E_INT_IRQ_AIA_DMAC_INT              = E_INT_IRQ_0x1E0_START + 4,   //M7642
    E_INT_IRQ_AIA_SEC_INT               = E_INT_IRQ_0x1E0_START + 5,   //M7642
    E_INT_IRQ_AIA_MDLA_S_INT            = E_INT_IRQ_0x1E0_START + 6,   //M7642
    E_INT_IRQ_DIP2                      = E_INT_IRQ_0x1E0_START + 7,   //M7642
    E_INT_IRQ_DIP2_SEC_INT              = E_INT_IRQ_0x1E0_START + 8,   //M7642
    E_INT_IRQ_MIPI_DSI                  = E_INT_IRQ_0x1E0_START + 9,
    E_INT_IRQ_VBDMA_MERGE               = E_INT_IRQ_0x1E0_START +10,   //MT5889
    E_INT_IRQ_FDVT_IRQ                  = E_INT_IRQ_0x1E0_START +11,   //MT5889
    E_INT_IRQ_FDVTBUS_IRQ               = E_INT_IRQ_0x1E0_START +12,   //MT5889
    E_INT_IRQ_MAX,
} InterruptNum;
