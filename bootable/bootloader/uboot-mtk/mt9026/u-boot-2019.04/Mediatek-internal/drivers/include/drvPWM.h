...
typedef enum _PWM_Seg_Type_Sel
{
    E_PWM_2048_SEG,
    E_PWM_4096_SEG,
    E_PWM_8192_SEG,
...
typedef struct _PWM_SegEvent_Arg
{
    MS_U32 u32Position;
    MS_BOOL bValue;
    MS_BOOL bEnable;
...
typedef struct _PWM_Seg_Cfg
{
    PWM_SegNum eSegNum;
    PWM_Seg_Type_Sel eSegTypeSel;
    PWM_Seg_Rst_Src eSegRstSrc;
    PWM_Seg_Db_Src eSegDbSrc;
    MS_BOOL bBypassDisable;
    MS_BOOL bResetEnable;
    MS_BOOL bEnable;
} PWM_Seg_Cfg;

typedef struct _PWM_Seg_UnitCfg
{
    PWM_Seg_Cfg sSegCfg[SEG_CFG_NUM];
    PWM_Np_Engine eNpEngine;
} PWM_Seg_UnitCfg;
...
typedef enum _PWM_Attribute
{
    E_PWM_ATTRI_USER_DRV,
    E_PWM_ATTRI_KERNEL_DRV,
    E_PWM_ATTRI_UNKNOWN,
}PWM_Attribute;
...
/// MDrv_PWM_Attribute
/// @ingroup G_PWM_CONTROL
/// @param PWMAttri \b IN: PWM_Attribute
/// @return TRUE  : Set Attribute success
/// @return FALSE : Set Attribute fail
//-------------------------------------------------------------------------------------------------
MS_BOOL MDrv_PWM_Attribute(PWM_Attribute PWMAttri);

void MDrv_PWM_3D_LR_Sync(PWM_ChNum u8IndexPWM, MS_BOOL bNvsPWM, N_LR_SYNC_SEL LrSyncSel, MS_U8 u8RstCnt);


//-------------------------------------------------------------------------------------------------
/// Description: Init PWM 4096 Segment Function
/// @ingroup G_PWM_CONTROL
/// @param psSegUnitCfg    \b IN: Structure of PWM Segment United Configurations;
/// @return TRUE : succeed
//-------------------------------------------------------------------------------------------------
MS_BOOL MDrv_PWM_Seg_Init(PWM_Seg_UnitCfg *psSegUnitCfg);

//-------------------------------------------------------------------------------------------------
/// Description: Set the Duty of the specific pwm segment
/// @ingroup G_PWM_CONTROL
/// @param eSegIndex     \b which pwm segment is setting
/// @param u32DutyPWM    \b the 24-bit Duty value
//-------------------------------------------------------------------------------------------------
void MDrv_PWM_Seg_DutyCycle(PWM_SegNum eSegIndex, MS_U32 u32DutyPWM);

//-------------------------------------------------------------------------------------------------
/// Description: Set the Shift of the specific pwm segment
/// @ingroup G_PWM_CONTROL
/// @param eSegIndex      \b which pwm segment is setting
/// @param u32ShiftPWM    \b the 24-bit Duty value
//-------------------------------------------------------------------------------------------------
void MDrv_PWM_Seg_Shift(PWM_SegNum eSegIndex, MS_U32 u32ShiftPWM);

//-------------------------------------------------------------------------------------------------
/// Description: Set Output select of the specific pwm
/// @ingroup G_PWM_CONTROL
/// @param eChIndex    \b which pwm is setting
/// @param eOutSel     \b pwm output select
/// @note    \n
///     2'd0: PWM         \n
///     2'd1: PWM seg0    \n
///     2'd2: PWM seg1    \n
//-------------------------------------------------------------------------------------------------
void MDrv_PWM_OutSel(PWM_ChNum eChIndex, PWM_Out_Sel eOutSel);

//-------------------------------------------------------------------------------------------------
/// Description: Set the vsync double buffer SW of the specific pwm segment
/// @ingroup G_PWM_CONTROL
/// @param eSegIndex     \b which pwm segment is setting
/// @param bEnable       \b TRUE/FALSE
//-------------------------------------------------------------------------------------------------
void MDrv_PWM_Seg_VDBen_SW(PWM_SegNum eSegIndex, MS_BOOL bEnable);

//-------------------------------------------------------------------------------------------------
/// Description: Set the M plus enable of the specific pwm
/// @ingroup G_PWM_CONTROL
/// @param eChIndex    \b which pwm is setting
/// @param bEnable     \b TRUE/FALSE
//-------------------------------------------------------------------------------------------------
void MDrv_PWM_MPlus_Enable(PWM_ChNum eChIndex, MS_BOOL bEnable);

//-------------------------------------------------------------------------------------------------
/// Description: Set the M plus enable of the specific pwm segment
/// @ingroup G_PWM_CONTROL
/// @param eSegIndex    \b which pwm segment is setting
/// @param bEnable      \b TRUE/FALSE
//-------------------------------------------------------------------------------------------------
void MDrv_PWM_Seg_MPlus_Enable(PWM_SegNum eSegIndex, MS_BOOL bEnable);

//-------------------------------------------------------------------------------------------------
/// Description: Set the Event value of the specific pwm segment
/// @ingroup G_PWM_CONTROL
/// @param eSegIndex       \b which pwm segment is setting
/// @param pArraySeting    \b the segment event value
/// @param u8ArraySize     \b the size of the segment event
/// @return TRUE  : succeed
/// @return FALSE : fail before timeout or illegal parameters
//-------------------------------------------------------------------------------------------------
MS_BOOL MDrv_PWM_Seg_Event_Set(PWM_SegNum eSegIndex, PWM_SegEvent_Arg *pArraySeting, MS_U8 u8ArraySize);
