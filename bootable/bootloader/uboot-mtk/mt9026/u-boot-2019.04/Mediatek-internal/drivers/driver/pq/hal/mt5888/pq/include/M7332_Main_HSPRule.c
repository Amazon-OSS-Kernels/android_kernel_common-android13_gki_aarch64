...
U8 MST_HSPRule_Array_Main[PQ_HSPRule_NUM_Main][PQ_HSPRule_IP_NUM_Main]=
{
    ...
    {//ScalingDown_00x_YUV, 2
        PQ_IP_HSP_Y_SRAM_2_6Tap_Main, PQ_IP_HSP_C_C_SRAM_1_Main, PQ_IP_SRAM2_InvSinc6Tc4p4Fc57Apass01Astop60_Main, PQ_IP_NULL, 
    },
    {//ScalingDown_00x_RGB, 3
        PQ_IP_HSP_Y_Bilinear_Main, PQ_IP_HSP_C_Bilinear_Main, PQ_IP_NULL, PQ_IP_NULL, 
    },
    ...
    {//H1920Up_NonStandard_YUV, 24
        PQ_IP_HSP_Y_SRAM_2_10Tap_Main, PQ_IP_HSP_C_C_SRAM_1_Main, PQ_IP_SRAM2_InvSinc10Tc4p4Fc95Apass0001Astop60_Main, PQ_IP_NULL, 
    },
    {//H1920Up_NonStandard_RGB, 25
        PQ_IP_HSP_Y_Bilinear_Main, PQ_IP_HSP_C_Bilinear_Main, PQ_IP_NULL, PQ_IP_NULL, 
    },
};
