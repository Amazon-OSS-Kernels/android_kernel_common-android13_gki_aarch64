...
#define GE_USE_I8_FOR_YUV_BLENDING (1)
...
#define GE_H_INFO(x, args...) ULOGI("GE HAL", x, ##args)
// Warning, illegal paramter but can be self fixed in functions
#define GE_H_WARN(x, args...) ULOGW("GE HAL", x, ##args)
//  Need debug, illegal paramter.
#define GE_H_DBUG(x, args...) ULOGD("GE HAL", x, ##args)
// Error, function will be terminated but system not crash
#define GE_H_ERR(x, args...) ULOGE("GE HAL", x, ##args)
// Critical, system crash. (ex. assert)
#define GE_H_FATAL(x, args...) ULOGF("GE HAL", x, ##args)
//-------------------------------------------------------------------------------------------------
//  Type and Structure
//-------------------------------------------------------------------------------------------------
