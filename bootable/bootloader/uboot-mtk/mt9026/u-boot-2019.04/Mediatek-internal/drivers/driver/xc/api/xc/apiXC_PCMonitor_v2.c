...
void PCMONITOR_Initialize(XC_INSTANCE_PRIVATE* psXCInstPri, const void* const pAttribute)
{
    ...
    psXCInstPri->fpXC_PCMonitor_Get_VFreqx10NoDelay =  MApi_XC_PCMonitor_Get_VFreqx10NoDelay_U2;
    psXCInstPri->fpXC_PCMonitor_Get_VFreqx1KNoDelay =  MApi_XC_PCMonitor_Get_VFreqx1KNoDelay_U2;
    ...
    psXCInstPri->fpXC_PCMonitor_GetTimingInfo = MApi_XC_PCMonitor_GetTimingInfo_U2;
...
MS_U32 _PCMONITORIoctl(void* pInstance, MS_U32 u32Cmd, void* pArgs)
{
    ...
    switch(u32Cmd)
    {
        ...
        case E_XC_PCMONITOR_CMD_GET_VFREQX10NODELAY:
            {

                pstXC_PCMONITOR_GET_VFREQX10NODELAY pXCArgs = (pstXC_PCMONITOR_GET_VFREQX10NODELAY) pArgs;
#if PIP_PATCH_USING_SC1_MAIN_AS_SC0_SUB
                USE_OTHER_SC_AS_SUB_WINDOW();
#endif
                pXCArgs->u16ReturnValue = psXCInstPri->fpXC_PCMonitor_Get_VFreqx10NoDelay(pInstance, pXCArgs->eWindow, pXCArgs->eType);

                u32Return = UTOPIA_STATUS_SUCCESS;
                break;
            }

        case E_XC_PCMONITOR_CMD_GET_VFREQX1KNODELAY:
            {

                pstXC_PCMONITOR_GET_VFREQX1KNODELAY pXCArgs = (pstXC_PCMONITOR_GET_VFREQX1KNODELAY) pArgs;
#if PIP_PATCH_USING_SC1_MAIN_AS_SC0_SUB
                USE_OTHER_SC_AS_SUB_WINDOW();
#endif
                pXCArgs->u32ReturnValue = psXCInstPri->fpXC_PCMonitor_Get_VFreqx1KNoDelay(pInstance, pXCArgs->eWindow, pXCArgs->eType);
        ...
        case E_XC_PCMONITOR_CMD_GETTIMINGINFO:
            {
                pstXC_PCMONITOR_GETTIMINGINFO pXCArgs = (pstXC_PCMONITOR_GETTIMINGINFO) pArgs;
#if PIP_PATCH_USING_SC1_MAIN_AS_SC0_SUB
                USE_OTHER_SC_AS_SUB_WINDOW();
#endif
                pXCArgs->eReturnValue = psXCInstPri->fpXC_PCMonitor_GetTimingInfo(pInstance, pXCArgs->eWindow, pXCArgs->pstPcMonitorTimngInfo);
