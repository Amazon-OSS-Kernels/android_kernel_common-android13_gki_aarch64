...
#define MIU1_GEGROUP                0x7AUL
#define GE_BANK_NUM                 0x2800
/*#define GE_REG(addr)                RIU[ (((addr)*2) + 0x2800UL)]
#define GE2_REG(addr)               RIU[ (((addr)*2) + 0x62800UL)]
#define CLK_REG(addr)               RIU[ (((addr)*2) + 0x0B00UL)]
#define INTR_CTNL_BK(addr)          RIU[ (((addr)*2) + 0x1900) ]*/

#define GE_REG(addr)	u16Riu_tmp
#define GE2_REG(addr)	u16Riu_tmp
#define CLK_REG(addr)	u16Riu_tmp
#define INTR_CTNL_BK(addr)	u16Riu_tmp

#define REG_BASE	(0x1C000000)
#if defined(CONFIG_SUPPORT_MULTI_GATE)
#define GCLK_REG(addr)          RIU[ (((addr)*2) + 0x270300UL) ]
#endif
...
#define _REG_GE_LINE_DELTA           0x0061UL
...
#define _REG_GE_LINE_LENGTH          0x0063UL
