...
#define LV_HOR_RES_MAX          (1920)//(3840)
#define LV_VER_RES_MAX          (1080)//(2160)
 ...
 */
#define LV_FONT_CUSTOM_DECLARE LV_FONT_DECLARE(lv_font_roboto_50)

/*Always set a default font from the built-in fonts*/
#define LV_FONT_DEFAULT        &lv_font_roboto_50
