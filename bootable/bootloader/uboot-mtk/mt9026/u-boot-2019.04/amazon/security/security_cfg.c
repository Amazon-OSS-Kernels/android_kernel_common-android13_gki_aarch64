...
#elif (defined(SBOOT_GINZAEU_BOARD))
	{GINZAEU_UNLOCK_PUBKEY};
#else
	{GINZA_UNLOCK_PUBKEY};
#endif
...
#if defined(UFBL_PROJ_GINZA)
		{YUBIKEY_PUB_KEY_TAG_GINZA_GM, g_yubikey_unlock_public_key_ginza_gm,
				sizeof(g_yubikey_unlock_public_key_ginza_gm)},
		{YUBIKEY_PUB_KEY_TAG_GINZA_DT, g_yubikey_unlock_public_key_ginza_dt,
				sizeof(g_yubikey_unlock_public_key_ginza_dt)},
		{YUBIKEY_PUB_KEY_TAG_GINZA_OH, g_yubikey_unlock_public_key_ginza_oh,
				sizeof(g_yubikey_unlock_public_key_ginza_oh)},
		{YUBIKEY_PUB_KEY_TAG_GINZA_GA, g_yubikey_unlock_public_key_ginza_ga,
				sizeof(g_yubikey_unlock_public_key_ginza_ga)},
		{YUBIKEY_PUB_KEY_TAG_GINZA_HH, g_yubikey_unlock_public_key_ginza_hh,
				sizeof(g_yubikey_unlock_public_key_ginza_hh)},
		{YUBIKEY_PUB_KEY_TAG_GINZA_HB_H, g_yubikey_unlock_public_key_ginza_hb_h,
				sizeof(g_yubikey_unlock_public_key_ginza_hb_h)},
		{YUBIKEY_PUB_KEY_TAG_GINZA_HB_B, g_yubikey_unlock_public_key_ginza_hb_b,
				sizeof(g_yubikey_unlock_public_key_ginza_hb_b)},
		{YUBIKEY_PUB_KEY_TAG_GINZA_HB_T, g_yubikey_unlock_public_key_ginza_hb_t,
				sizeof(g_yubikey_unlock_public_key_ginza_hb_t)},
		{YUBIKEY_PUB_KEY_TAG_GINZA_HB_M, g_yubikey_unlock_public_key_ginza_hb_m,
				sizeof(g_yubikey_unlock_public_key_ginza_hb_m)},
#elif defined(UFBL_PROJ_GINZAEU)
		{YUBIKEY_PUB_KEY_TAG_GINZAEU_GM, g_yubikey_unlock_public_key_ginzaeu_gm,
				sizeof(g_yubikey_unlock_public_key_ginzaeu_gm)},
		{YUBIKEY_PUB_KEY_TAG_GINZAEU_SP, g_yubikey_unlock_public_key_ginzaeu_sp,
				sizeof(g_yubikey_unlock_public_key_ginzaeu_sp)},
		{YUBIKEY_PUB_KEY_TAG_GINZAEU_MT, g_yubikey_unlock_public_key_ginzaeu_mt,
				sizeof(g_yubikey_unlock_public_key_ginzaeu_mt)},
		{YUBIKEY_PUB_KEY_TAG_GINZAEU_NM, g_yubikey_unlock_public_key_ginzaeu_nm,
				sizeof(g_yubikey_unlock_public_key_ginzaeu_nm)},
		{YUBIKEY_PUB_KEY_TAG_GINZAEU_BM, g_yubikey_unlock_public_key_ginzaeu_bm,
				sizeof(g_yubikey_unlock_public_key_ginzaeu_bm)},
		{YUBIKEY_PUB_KEY_TAG_GINZAEU_SV, g_yubikey_unlock_public_key_ginzaeu_sv,
				sizeof(g_yubikey_unlock_public_key_ginzaeu_sv)},
#elif defined(UFBL_PROJ_abc123)
		{YUBIKEY_PUB_KEY_TAG_abc123_FF, g_yubikey_unlock_public_key_abc123_ff,
				sizeof(g_yubikey_unlock_public_key_abc123_ff)},
#endif
		{NULL, NULL, 0},
	};
