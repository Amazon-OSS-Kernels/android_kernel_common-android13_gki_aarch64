...
/* MTK code identification */
#define MTK_CUSTOMIZATION   1
...
#define EXT_SECURE_FEATURE_SUPPORT	231	/* RO */
...
#define SEC_SANITIZE	BIT(6)
#define SEC_GB_CL_EN	BIT(4)
#define SEC_BD_BLK_EN	BIT(2)
#define SECURE_ER_EN	BIT(0)
...
#if defined(MTK_CUSTOMIZATION) && MTK_CUSTOMIZATION
#define EXT_CSD_PWR_ON          1
#define EXT_CSD_PWR_OFF_SHORT   2
#define EXT_CSD_PWR_OFF_LONG    3
#endif // End of defined(MTK_CUSTOMIZATION) && MTK_CUSTOMIZATION
...
#define FAT_WRITE_BUF_ADDR      0x20200000
#define FAT_BUFFER_LEN          0x3200000
#define GPT_HEADER_SIZE         0x200000
...
struct dm_mmc_ops {
	...
	/* select_drive_strength() - select driving strength for different speed mode */
	int (*select_drive_strength)(struct udevice *dev, int mode);
};
...
int mmc_select_drive_strength(struct mmc *mmc, int mode);
#else
struct mmc_ops {
