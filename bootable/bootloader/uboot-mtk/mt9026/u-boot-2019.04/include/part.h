...
typedef struct disk_partition {
	...
	int system;     /* Active System partition flag is set  */
	int hideefi;    /* Active Hide from EFI flag is set  */
	int ro;         /* Active Read-only flag is set  */
	int hide;       /* Active Hidden flag is set  */
	int nomount;    /* Active Not mount(do not automount) flag is set  */
