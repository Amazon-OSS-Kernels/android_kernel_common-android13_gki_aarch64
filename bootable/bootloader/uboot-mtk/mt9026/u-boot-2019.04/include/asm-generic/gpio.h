 ...
 * @gpio_max_count: Max number of GPIOs in this device. If @gpio_max_count
 * is not equal 0, @gpio_base for device 1 will equal @gpio_max_count in
 * device 0.
