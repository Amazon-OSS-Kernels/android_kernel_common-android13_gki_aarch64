...
/**
 * Do dtb overlay in the FDT
 *
 * This function read dtb data from partition and do deb overlay for add board related information.
 *
 * @kernel_dtb_addr:	kernel dtb address
 * @partition_name:	source partition name
