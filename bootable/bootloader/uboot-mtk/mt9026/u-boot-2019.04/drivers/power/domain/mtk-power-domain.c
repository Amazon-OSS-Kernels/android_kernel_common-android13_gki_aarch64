...
#include <dt-bindings/power/mt5896-power.h>
...
static struct scp_domain_data scp_domain_mt5888[] = {
	[MT5888_POWER_DOMAIN_ETHSYS] = {
		.sta_mask = PWR_STATUS_ETHSYS,
		.ctl_offs = SPM_ETHSYS_PWR_CON,
		.sram_pdn_bits = GENMASK(11, 8),
		.sram_pdn_ack_bits = GENMASK(15, 12),
...
static struct scp_domain_data scp_domain_mt5896[] = {
	[MT5896_POWER_DOMAIN_ETHSYS] = {
		.sta_mask = PWR_STATUS_ETHSYS,
		.ctl_offs = SPM_ETHSYS_PWR_CON,
		.sram_pdn_bits = GENMASK(11, 8),
		.sram_pdn_ack_bits = GENMASK(15, 12),
...
static int mtk_power_domain_hook(struct udevice *dev)
{
	...
	case SCPSYS_MT7629:
		...
		break;
    case SCPSYS_MT5888:
		scpd->data = scp_domain_mt5888;
		break;
    case SCPSYS_MT5896:
		scpd->data = scp_domain_mt5896;
		break;
	default:
		return -EINVAL;
	}
...
static const struct udevice_id mtk_power_domain_ids[] = {
    ...
    {
		.compatible = "mediatek,mt5896-scpsys",
		.data = SCPSYS_MT5896,
	},
	{ /* sentinel */ }
};
