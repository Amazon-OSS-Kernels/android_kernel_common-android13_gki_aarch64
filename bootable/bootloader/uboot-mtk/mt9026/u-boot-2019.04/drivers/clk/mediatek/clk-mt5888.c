...
/*
 * MediaTek clock driver for MT5888 SoC
 *
...
#define MT5888_CLKSQ_STB_CON0		0x20
#define MT5888_PLL_ISO_CON0		0x2c
#define MT5888_PLL_FMAX			(2500UL * MHZ)
#define MT5888_CON0_RST_BAR		BIT(24)
...
#define PLL(_id, _reg, _pwr_reg, _en_mask, _flags, _pcwbits, _pd_reg,	\
		...
		.pwr_reg = _pwr_reg,					\
		.en_mask = _en_mask,					\
		.rst_bar_mask = MT5888_CON0_RST_BAR,			\
		.fmax = MT5888_PLL_FMAX,				\
		.flags = _flags,					\
		.pcwbits = _pcwbits,					\
		.pd_reg = _pd_reg,					\
		.pd_shift = _pd_shift,					\
...
static const struct mtk_clk_tree mt5888_clk_tree = {
	.xtal_rate = 40 * MHZ,
	.xtal2_rate = 20 * MHZ,
...
static int mt5888_mcucfg_probe(struct udevice *dev)
{
	void __iomem *base;
...
static int mt5888_apmixedsys_probe(struct udevice *dev)
{
	struct mtk_clk_priv *priv = dev_get_priv(dev);
	int ret;

	ret = mtk_common_clk_init(dev, &mt5888_clk_tree);
	if (ret)
		return ret;

	/* reduce clock square disable time */
	writel(0x501, priv->base + MT5888_CLKSQ_STB_CON0);
	/* extend pwr/iso control timing to 1us */
	writel(0x80008, priv->base + MT5888_PLL_ISO_CON0);

	return 0;
}

static int mt5888_topckgen_probe(struct udevice *dev)
{
	return mtk_common_clk_init(dev, &mt5888_clk_tree);
}

static int mt5888_infracfg_probe(struct udevice *dev)
{
	return mtk_common_clk_gate_init(dev, &mt5888_clk_tree, infra_cgs);
}

static int mt5888_pericfg_probe(struct udevice *dev)
{
	return mtk_common_clk_gate_init(dev, &mt5888_clk_tree, peri_cgs);
}

static int mt5888_ethsys_probe(struct udevice *dev)
{
	return mtk_common_clk_gate_init(dev, &mt5888_clk_tree, eth_cgs);
}

static int mt5888_ethsys_bind(struct udevice *dev)
{
	int ret = 0;
...
static int mt5888_sgmiisys_probe(struct udevice *dev)
{
	return mtk_common_clk_gate_init(dev, &mt5888_clk_tree, sgmii_cgs);
}

static const struct udevice_id mt5888_apmixed_compat[] = {
	{ .compatible = "mediatek,mt5888-apmixedsys" },
	{ }
};

static const struct udevice_id mt5888_topckgen_compat[] = {
	{ .compatible = "mediatek,mt5888-topckgen" },
	{ }
};

static const struct udevice_id mt5888_infracfg_compat[] = {
	{ .compatible = "mediatek,mt5888-infracfg", },
	{ }
};

static const struct udevice_id mt5888_pericfg_compat[] = {
	{ .compatible = "mediatek,mt5888-pericfg", },
	{ }
};

static const struct udevice_id mt5888_ethsys_compat[] = {
	{ .compatible = "mediatek,mt5888-ethsys", },
	{ }
};

static const struct udevice_id mt5888_sgmiisys_compat[] = {
	{ .compatible = "mediatek,mt5888-sgmiisys", },
	{ }
};

static const struct udevice_id mt5888_mcucfg_compat[] = {
	{ .compatible = "mediatek,mt5888-mcucfg" },
	{ }
};
...
U_BOOT_DRIVER(mtk_mcucfg) = {
	.name = "mt5888-mcucfg",
	.id = UCLASS_SYSCON,
	.of_match = mt5888_mcucfg_compat,
	.probe = mt5888_mcucfg_probe,
	.flags = DM_FLAG_PRE_RELOC,
};

U_BOOT_DRIVER(mtk_clk_apmixedsys) = {
	.name = "mt5888-clock-apmixedsys",
	.id = UCLASS_CLK,
	.of_match = mt5888_apmixed_compat,
	.probe = mt5888_apmixedsys_probe,
...
U_BOOT_DRIVER(mtk_clk_topckgen) = {
	.name = "mt5888-clock-topckgen",
	.id = UCLASS_CLK,
	.of_match = mt5888_topckgen_compat,
	.probe = mt5888_topckgen_probe,
	.priv_auto_alloc_size = sizeof(struct mtk_clk_priv),
...
U_BOOT_DRIVER(mtk_clk_infracfg) = {
	.name = "mt5888-clock-infracfg",
	.id = UCLASS_CLK,
	.of_match = mt5888_infracfg_compat,
	.probe = mt5888_infracfg_probe,
...
U_BOOT_DRIVER(mtk_clk_pericfg) = {
	.name = "mt5888-clock-pericfg",
	.id = UCLASS_CLK,
	.of_match = mt5888_pericfg_compat,
	.probe = mt5888_pericfg_probe,
	.priv_auto_alloc_size = sizeof(struct mtk_cg_priv),
	.ops = &mtk_clk_gate_ops,
	.flags = DM_FLAG_PRE_RELOC,
};
...
U_BOOT_DRIVER(mtk_clk_ethsys) = {
	.name = "mt5888-clock-ethsys",
	.id = UCLASS_CLK,
	.of_match = mt5888_ethsys_compat,
	.probe = mt5888_ethsys_probe,
	.bind = mt5888_ethsys_bind,
	.priv_auto_alloc_size = sizeof(struct mtk_cg_priv),
	.ops = &mtk_clk_gate_ops,
};

U_BOOT_DRIVER(mtk_clk_sgmiisys) = {
	.name = "mt5888-clock-sgmiisys",
	.id = UCLASS_CLK,
	.of_match = mt5888_sgmiisys_compat,
	.probe = mt5888_sgmiisys_probe,
	.priv_auto_alloc_size = sizeof(struct mtk_cg_priv),
	.ops = &mtk_clk_gate_ops,
};
