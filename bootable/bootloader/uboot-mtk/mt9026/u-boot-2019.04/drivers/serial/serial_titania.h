...
//-------------------------------------------------------------------------------------------------
/*
* TODO: Set baud rate as 38400 for HAPS stage
* It will set to 115200 after bring up success
*/
...
#if defined(__ARM__)
/*
* TODO: Get RIU base register definition from ROM table
* after ROM table release
*/
#if defined(CONFIG_TARGET_MT5896)
#define REG_UART0_BASE              0x1C061000
#define REG_UART1_BASE              0x1C061000
#define REG_UART2_BASE              0x1C061000
#else
...
#define REG_PM_OFFSET               0x9
#endif
#define UART_PM_REG8(addr)          *((volatile unsigned int*)(REG_PM_BASE + ((addr)<<1)))
