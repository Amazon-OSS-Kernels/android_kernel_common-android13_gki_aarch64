...
typedef smp_spin_lock_t spinlock_t;
#define spin_lock_init(lock) smp_spin_lock_init(lock)
#define spin_lock(lock) smp_spin_lock(lock)
#define spin_unlock(lock) smp_spin_unlock(lock)
#define spin_lock_irqsave(lock, flags) smp_spin_lock_save(lock, flags)
#define spin_unlock_irqrestore(lock, flags) smp_spin_unlock_restore(lock, flags)
#else
