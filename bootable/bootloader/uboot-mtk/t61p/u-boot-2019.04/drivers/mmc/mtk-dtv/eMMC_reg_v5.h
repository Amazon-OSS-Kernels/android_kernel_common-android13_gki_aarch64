...
/* FCIE_MIU_DMA_ADDR_15_0 0x03 */
#define BIT_MIU_DMA_ADDR_15_0_MASK      (BIT16 - 1)

/* FCIE_MIU_DMA_ADDR_31_16 0x04 */
#define BIT_MIU_DMA_ADDR_31_16_SHIFT    16

/*FCIE_MIU_DMA_LEN_15_0 0x5*/
#define BIT_MIU_DMA_LEN_15_0_MASK       (BIT16 - 1)

/*FCIE_MIU_DMA_LEN_31_16 0x6*/
#define BIT_MIU_DMA_LEN_31_16_SHIFT     16
...
#define BITS_ERROR                      (BIT_SD_R_CRC_ERR | BIT_DAT_WR_CERR | BIT_DAT_WR_TOUT |\
					BIT_CMD_NO_RSP | BIT_CMD_RSP_CERR | BIT_DAT_RD_TOUT)
...
#define BIT_CQE_DBUS_MODE               (BIT3 | BIT2 | BIT1)
...
/*FCIE_MIU_DMA_ADDR_47_32 0X29*/
#define BIT_MIU_DMA_ADDR_47_32_SHIFT    32
...
/* FCIE_BOOT 0x38 */
#define BIT_DEBUG0_MODE_MSK             (BIT3 | BIT2 | BIT1 | BIT0)

/* FCIE_BOOT 0x39 */
#define BIT_DEBUG1_MODE_MSK             (BIT11 | BIT10 | BIT9 | BIT8)
#define BIT_DEBUG1_MODE_SET             (BIT10 | BIT8)
