...
const struct flash_info spi_nor_ids[] = {
	...
	{
		INFO("gd25q40c", 0xc84013, 0, 64 * 1024, 8,
			SECT_4K | SPI_NOR_DUAL_READ | SPI_NOR_QUAD_READ |
			SPI_NOR_HAS_LOCK | SPI_NOR_HAS_TB)
	},
	{
	...
	{ INFO("mx25v4035f", 0xc22313, 0, 64 * 1024, 8, SECT_4K | SPI_NOR_DUAL_READ) },
	...
	{ INFO("w25x40cl", 0xef3013, 0, 64 * 1024,  8,  SECT_4K) },
	...
	{ INFO("XT25QF80B", 0x204014, 0, 64 * 1024, 256, SECT_4K) },
#endif
	/* Puya */
	{ INFO("P25Q80H", 0x856014, 0, 64 * 1024, 128, SECT_4K | SPI_NOR_DUAL_READ) },
	{ INFO("P25Q21H", 0x854012, 0, 64 * 1024, 4, SECT_4K | SPI_NOR_DUAL_READ) },
...
#endif
	/*GT25Q80A*/
	{ INFO("GT25Q80A",0xC46014, 0, 64 * 1024, 16,  SECT_4K) },
	{ },
};
