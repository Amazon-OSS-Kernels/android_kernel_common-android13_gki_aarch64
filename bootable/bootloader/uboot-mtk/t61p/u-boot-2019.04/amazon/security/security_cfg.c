...
const unsigned char *amzn_get_unlock_key(unsigned int *key_len)
{
	...
	{ MT9025_3P_UNLOCK_PUBKEY };
        ...
        { MT9025_1P_abc123EU_UNLOCK_PUBKEY };
#elif (defined(SBOOT_abc123_BOARD))
        { MT9025_1P_abc123_UNLOCK_PUBKEY };
#elif (defined(SBOOT_COYOTEEU_BOARD))
        { COYOTEEU_UNLOCK_PUBKEY };
#elif (defined(SBOOT_COYOTE_BOARD))
        { COYOTE_UNLOCK_PUBKEY };
#else
	{ 0x00 };
#endif
...
int amzn_yk_get_pub_key_list(const amzn_yk_pub_key_t **key_list)
{
	...
	static const amzn_yk_pub_key_t keys[] = {
		...
		{YUBIKEY_PUB_KEY_TAG_COYOTE_CH, g_yubikey_unlock_public_key_coyote_ch,
				sizeof(g_yubikey_unlock_public_key_coyote_ch)},
#elif defined(UFBL_PROJ_COYOTEEU)
		{YUBIKEY_PUB_KEY_TAG_COYOTEEU_PV, g_yubikey_unlock_public_key_coyoteeu_pv,
				sizeof(g_yubikey_unlock_public_key_coyoteeu_pv)},
#endif
		{NULL, NULL, 0},
	};
