...
smp_spin_lock_t env_lock = INIT_SPIN_LOCK;
#endif
...
DECLARE_GLOBAL_DATA_PTR;
	...
	!defined(CONFIG_ENV_IS_IN_CUST_EXT4)	&& \
...
# error Define one of CONFIG_ENV_IS_IN_{EEPROM|FLASH|MMC|UFS|FAT|EXT4|\
