...
NXTARG:
	...
	/* When USB ethernet device detected, force fastboot using udp mode */
	usb_eth_exist = fastboot_do_usb_start() == 0;
#endif
	if (!strcmp(argv[1], "udp") || usb_eth_exist)
