...
int env_cus_load(void)
{
	...
	run_command("addbootargs vmpressure_level_critical 80", 0);
	run_command("addbootargs cgroup.memory nokmem", 0);
	run_command("addbootargs utpa_str_fr 1", 0);
	run_command("addbootargs 8250.nr_uarts 4", 0);
