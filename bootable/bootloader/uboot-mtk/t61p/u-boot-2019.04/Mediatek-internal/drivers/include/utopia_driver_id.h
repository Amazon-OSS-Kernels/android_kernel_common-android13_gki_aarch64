...
#ifndef _UTOPIA_DRIVER_ID_PRI_H_
#if defined(CONFIG_CC_IS_CLANG) && defined(MSOS_TYPE_LINUX_KERNEL)
...
MS_U32 SEALOpen(void** ppInstance, MS_U32 u32ModuleVersion, void* pAttribute);
...
MS_U32 LDOpen(void** ppInstance, const void* const pAttribute);
...
MS_U32 HDMIEARCOpen(void** ppInstance, const void* const pAttribute);
...
MS_U32 GESTROpen(void** ppInstance, MS_U32 u32ModuleVersion, void* pAttribute);
...
MS_U32 URDMAOpen(void** ppInstance, MS_U32 u32ModuleVersion, void* pAttribute);
...
MS_U32 MSB124XOpen(void** ppInstance, MS_U32 u32ModuleVersion, void* pAttribute);
...
MS_U32 PKAOpen(void** ppInstance, MS_U32 u32ModuleVersion, void* pAttribute);
MS_U32 MFDOpen(void** ppInstance, MS_U32 u32ModuleVersion, void* pAttribute);
MS_U32 VENCOpen(void** ppInstance, MS_U32 u32ModuleVersion, void* pAttribute);
#else
...
extern __attribute__((weak)) MS_U32 HDMIEARCOpen(void** ppInstance, const void* const pAttribute);
...
extern __attribute__((weak)) MS_U32 MDLAOpen(void** ppInstance, MS_U32 u32ModuleVersion, void* pAttribute);
extern __attribute__((weak)) MS_U32 POSTPROCESSOpen(void** ppInstance, MS_U32 u32ModuleVersion, void* pAttribute);
extern __attribute__((weak)) MS_U32 EXECUTOROpen(void** ppInstance, MS_U32 u32ModuleVersion, void* pAttribute);
#endif
#endif
...
#define MODULE_TYPE_HDMIEARC_FULL HDMIEARCOpen
...
#define MODULE_TYPE_MDLA_FULL 1
#define MODULE_TYPE_POSTPROCESS_FULL 1
#define MODULE_TYPE_EXECUTOR_FULL 1
