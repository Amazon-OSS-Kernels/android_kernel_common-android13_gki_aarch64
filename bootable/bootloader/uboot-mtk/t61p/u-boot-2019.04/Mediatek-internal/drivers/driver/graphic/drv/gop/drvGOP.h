...
#else
#define getpid() 0UL
#define MsOS_GetOSThreadID(args...) (-1)
#endif
...
#define BRIGHTNESS_OFFSET          0x400UL

#define GOP_MAX_SUPPORT_DEFAULT      (6)
#define GOP_INTERMIU_SEL_NUM         (8)
...
#define GOP_CAPS_MAJOR_IPVERSION_OFFSET_MSK BMASK(15:8)
#define GOP_CAPS_MAJOR_IPVERSION_OFFSET_SHT	8
#define GOP_CAPS_MINOR_IPVERSION_OFFSET_MSK	BMASK(7:0)

#define GOP_M6_SERIES_MAJOR	(1)
#define GOP_M6L_SERIES_MINOR	(1)
#define GOP_M6_E3_SERIES_MINOR	(2)
#define GOP_M6L_E3_SERIES_MINOR	(3)

#define GOP_MOKONA_SERIES_MAJOR	(2)

#define GOP_MOKA_SERIES_MAJOR	(3)
#define GOP_MOKA_SERIES_MINOR	(0)

#define H4TAP55_C0	(0x9A)
#define H4TAP55_C1	(0x33)
#define H4TAP55_C2	(0x90)
#define H4TAP55_C3	(0x19)
#define H4TAP55_C4	(0x03)
#define H4TAP55_C5	(0x54)
#define H4TAP55_C6	(0x76)
#define H4TAP55_C7	(0x0A)

#define H4TAP65_C0	(0xAC)
#define H4TAP65_C1	(0x2A)
#define H4TAP65_C2	(0xA0)
#define H4TAP65_C3	(0x10)
#define H4TAP65_C4	(0x0)
#define H4TAP65_C5	(0x50)
#define H4TAP65_C6	(0x7C)
#define H4TAP65_C7	(0x04)

#define H4TAP75_C0	(0xB0)
#define H4TAP75_C1	(0x28)
#define H4TAP75_C2	(0xAF)
#define H4TAP75_C3	(0x07)
#define H4TAP75_C4	(0x1F3)
#define H4TAP75_C5	(0x57)
#define H4TAP75_C6	(0x8A)
#define H4TAP75_C7	(0x1F6)

#define H4TAP85_C0	(0xDC)
#define H4TAP85_C1	(0x12)
#define H4TAP85_C2	(0xC2)
#define H4TAP85_C3	(0x1FE)
#define H4TAP85_C4	(0x1FE)
#define H4TAP85_C5	(0x42)
#define H4TAP85_C6	(0x85)
#define H4TAP85_C7	(0x1FB)

#define H4TAP95_C0	(0xF4)
#define H4TAP95_C1	(0x06)
#define H4TAP95_C2	(0xD5)
#define H4TAP95_C3	(0x1F5)
#define H4TAP95_C4	(0x1FD)
#define H4TAP95_C5	(0x39)
#define H4TAP95_C6	(0x89)
#define H4TAP95_C7	(0x1F7)

#define H4TAP105_C0	(0x110)
#define H4TAP105_C1	(0x1F8)
#define H4TAP105_C2	(0xE9)
#define H4TAP105_C3	(0x1E4)
#define H4TAP105_C4	(0x1FC)
#define H4TAP105_C5	(0x37)
#define H4TAP105_C6	(0x93)
#define H4TAP105_C7	(0x1ED)
//-------------------------------------------------------------------------------------------------
//  Type and Structure
//-------------------------------------------------------------------------------------------------
...
{
    E_DRV_BRI_SIGNBIT   =   0,
    E_DRV_BRI_2SCOMPLEMENT  =   1,
    E_DRV_BRI_MAX   =   2,
} EN_DRV_GOP_BRIG_INFO;
...
typedef struct __attribute__((packed))
{
    ...
    MS_BOOL bTLBSupport[GOP_MAX_SUPPORT_DEFAULT];
    MS_BOOL bInternalMIUSelect[GOP_INTERMIU_SEL_NUM];
    ...
    MS_BOOL bGOPWithScaleDown[GOP_MAX_SUPPORT_DEFAULT];
    ...
    MS_BOOL bH4tap256Phase;
    MS_BOOL bV4tap256Phase;
    MS_BOOL bSupportMixerSDR2HDR;
    MS_BOOL bSupporBrightness3Chan;
    MS_BOOL bSupportContrast;
    ...
    EN_DRV_GOP_BRIG_INFO enBrightnessInfo;
    MS_BOOL bSupportCSCTuning;
    MS_BOOL bSupportXC2DMenuLoad;
    ...
    MS_BOOL bAutoDetectVersion_1_0[SHARED_GOP_MAX_COUNT];
    MS_BOOL bUse3x3MartixCSC;
    MS_BOOL bAutoDetectVersion_2_0[SHARED_GOP_MAX_COUNT];
    MS_BOOL bSupportV2tap_16Phase[GOP_MAX_SUPPORT_DEFAULT];
    MS_BOOL b120HzDstOP;
    MS_BOOL bSupportTwoLineBuffer[GOP_MAX_SUPPORT_DEFAULT];
    MS_BOOL bSupportTrigBit;
    MS_BOOL bSupportCSCDoubleBuffer;
	MS_U16 TotalGOPNum;
}GOP_CHIP_PROPERTY;
...
typedef enum
{
    ...
    E_DRV_GOP_HSTRCH_NEW4TAP_105_GAIN22 = 0x15,
    E_DRV_GOP_HSTRCH_NEW4TAP_105_GAIN31 = 0x16,
    E_DRV_GOP_HSTRCH_NEW4TAP_105_GAIN16 = 0x17,
    E_DRV_GOP_HSTRCH_NEW4TAP_105_GAIN17 = 0x18,
...
typedef enum
{
    ...
    E_DRV_GOP_VSTRCH_V4TAP_105_GAIN22 = 8,
    E_DRV_GOP_VSTRCH_V4TAP_105_GAIN31 = 9,
    E_DRV_GOP_VSTRCH_V4TAP_105_GAIN16 = 0xA,
    E_DRV_GOP_VSTRCH_V4TAP_105_GAIN17 = 0xB,
...
typedef enum
{
    E_DRV_GOP_MWIN_SET_COLORKEY,
    E_DRV_GOP_MWIN_SET_FRAMECOLOR,
    E_DRV_GOP_MIWIN_GET_COLORKEY,
    E_DRV_GOP_MWIN_GET_FRAMECOLOR,
}E_DRV_GOP_MWIN_COLORKEY_MODE;
...
typedef struct __attribute__((packed))
{
    ...
    MS_U16 u16WinVstart;
    MS_U16 u16WinVend;
}DRV_GOP_MULTIWIN_COLORKEY_Info, *PDRV_GOP_MULTIWIN_COLORKEY_Info;
...
typedef struct __attribute__((packed))
{
    ...
    MS_U8 u8frameCr_R;
    MS_U8 u8frameCb_B;
}DRV_GOP_MULTIWIN_FRAMECOLOR, *PDRV_GOP_MULTIWIN_FRAMECOLOR;

typedef enum
{
    E_DRV_GOP_SDR2HDR_OFF,
    E_DRV_GOP_SDR2HDR_HDR10,
}EN_DRV_GOP_SDR2HDR;
...
typedef enum
{
    E_DRV_GOP_VOPPATH_DEF                = 0x0, /// Select osd blending position at last
    E_DRV_GOP_VOPPATH_BEF_RGB3DLOOKUP    = 0x1, /// Select osd blending position before RGB 3D LookUP
    E_DRV_GOP_VOPPATH_BEF_PQGAMMA        = 0x2, /// Select osd blending position before gamma table
    E_DRV_GOP_VOPPATH_AFT_PQGAMMA        = 0x3, /// Select osd blending position after gamma table
    E_DRV_GOP_VOPPATH_AFT_LD             = 0x4, /// Select osd blending position after LD
...
typedef struct DLL_PACKED
{
    ...
    ///Reg Mask (IN)
    MS_U16 u16Mask;
}ST_MENULOAD_REGISTER;

typedef enum
{
    E_DRV_GOP_FORCEWRITE,
    E_DRV_GOP_BNKFORCEWRITE,
    E_DRV_GOP_WITHVSYNC,
    E_DRV_GOP_WITHSYNC_MULTIGOPUPDATED,
} E_DRV_GOPTriggerMode;
//-------------------------------------------------------------------------------------------------
...
GOP_Result MDrv_GOP_SetCSCCtrl(MS_GOP_CTX_LOCAL* pGOPCtx,MS_U32 u32GOPNum,ST_GOP_CSC_TABLE *pstCSCParam);
